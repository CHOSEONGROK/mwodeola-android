...
import com.jojo.android.mwodeola.databinding.FragmentKeyPadAlphabetBinding

class KeyPadAlphabetFragment(
    private val listener: BaseAuthenticationBottomSheet.OnSecureKeyPadListener
) : Fragment(), View.OnClickListener {

    private lateinit var binding: FragmentKeyPadAlphabetBinding
    ...
    ): View = FragmentKeyPadAlphabetBinding
